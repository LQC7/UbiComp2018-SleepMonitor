...
microphone, light sensor and orientation sensor. The collected sensor data are sent via Bluetooth to a XiaoMI Note2 Android smartphone for post-processing and
event detection.
...
\begin{figure}[!t]
	\centering
	\includegraphics[width=0.85\linewidth]{Figures/setup.pdf}
...
collected \FIXME{210} sets of nocturnal sleep data from our participants. During the experiment, our volunteers slept alone in a bedroom at
...
Charge2 which is proven to be accurate in monitoring user's sleep stages\FIXME{~\cite{evenson2015systematic}}. Therefore, our participants are asked to wear two
